  ...
  return (
    <main style={{ padding: 24, fontFamily: "system-ui" }}>
      ...
      <div style={{ marginTop: 16, display: "flex", gap: 10, flexWrap: "wrap" }}>
        ...
        <button onClick={() => router.push("/admin/news")} style={navButtonStyle}>
          Admin News →
        </button>

        {/*  NEW: Player Props admin */}
        <button onClick={() => router.push("/admin/player-props")} style={navButtonStyle}>
          Admin Player Props →
        </button>
        ...
        <Link href="/admin/news" style={{ alignSelf: "center", opacity: 0.85 }}>
          /admin/news
        </Link>

        {/*  NEW */}
        <Link href="/admin/player-props" style={{ alignSelf: "center", opacity: 0.85 }}>
          /admin/player-props
        </Link>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: 13, opacity: 0.85, lineHeight: "18px" }}>
          ...
          <br />
          locksAt (Phoenix): <b>{locksAt ? toPhoenixString(locksAt) : "n/a"}</b>
        </div>
        ...
        <div style={{ marginTop: 10, fontSize: 12, opacity: 0.75 }}>
          Tip: keep <code>locksAt</code> set correctly for the automatic lock, and use “Lock Picks
          Now” only as a backup.
        </div>
      </div>
