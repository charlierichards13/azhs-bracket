...
//       {/* ✅ Score bubble (only shows when score exists) */}
//       <div
//         style={{
//           flex: "0 0 auto",
//           minWidth: 34,
...
//           background: showScore ? "rgba(255,255,255,0.08)" : "transparent",
//           border: showScore ? "1px solid rgba(255,255,255,0.14)" : "1px solid transparent",
...
function TeamRow({
  ...
  return (
    ...
    >
      ...
      {/* ✅ Score bubble (shifted left + colored) */}
      <div
        style={{
          flex: "0 0 auto",
          minWidth: 32,
          ...
          fontWeight: 900,
          letterSpacing: 0.2,
          marginRight: 40, // ✅ key: leaves room for the top-right game id label
          ...(showScore ? scoreStyle : {}),
          opacity: showScore ? 1 : 0,
          boxSizing: "border-box",
        }}
        aria-hidden={!showScore}
...
function GameCard({ game, teamMap }: { game: Game; teamMap: Map<string, Team> }) {
  ...
  // Only color when both exist and not tied
  const aColor: "green" | "red" | "neutral" =
    hasBothScores && a !== b ? (a > b ? "green" : "red") : "neutral";
  const bColor: "green" | "red" | "neutral" =
    hasBothScores && a !== b ? (b > a ? "green" : "red") : "neutral";
